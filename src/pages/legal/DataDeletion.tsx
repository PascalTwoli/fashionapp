...
import deletionContent from '../../../docs/legal/DATA_DELETION_POLICY.md?raw';
...
const DataDeletion = () => {
  const html    = useMemo(() => mdToHtml(deletionContent), []);
  const toc     = useMemo(() => extractToc(deletionContent), []);
