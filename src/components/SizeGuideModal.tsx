		...
		<>
			...
			>
				...
				<div className="p-6 space-y-6">
						...
						<div className="space-y-3 text-sm">
							<div>
								...
								<p className="text-muted-foreground">
									Measure across the fullest part of your chest, keeping the tape parallel to the ground.
								</p>
							</div>
							<div>
								<p className="font-medium mb-1">Waist</p>
								<p className="text-muted-foreground">
									Measure around your natural waist, where your body naturally bends.
								</p>
							</div>
							<div>
								<p className="font-medium mb-1">Length</p>
								<p className="text-muted-foreground">
									For tops: measure from the shoulder seam to the hem. For pants: measure from the waistband to the ankle.
								</p>
							</div>
						</div>
					</section>
					...
					{/* Size Chart */}
					<section>
						<h3 className="text-base font-semibold mb-3">Size Chart (cm)</h3>
						<div className="overflow-x-auto">
							<table className="w-full text-sm border-collapse">
								<thead>
									<tr className="border-b border-border">
										<th className="text-left py-2 px-2 font-medium">Size</th>
										<th className="text-left py-2 px-2 font-medium">XS</th>
										<th className="text-left py-2 px-2 font-medium">S</th>
										<th className="text-left py-2 px-2 font-medium">M</th>
										<th className="text-left py-2 px-2 font-medium">L</th>
										<th className="text-left py-2 px-2 font-medium">XL</th>
									</tr>
								</thead>
								<tbody>
									<tr className="border-b border-border">
										<td className="py-2 px-2 font-medium">Chest (cm)</td>
									...
									<tr className="border-b border-border">
										<td className="py-2 px-2 font-medium">Waist (cm)</td>
									...
									<tr>
										<td className="py-2 px-2 font-medium">Length (cm)</td>
						...
						<div className="space-y-3 text-sm">
							<div className="flex gap-3">
								...
								<div>
									...
									<p className="text-muted-foreground">Close to the body with minimal ease</p>
								</div>
							</div>
							<div className="flex gap-3">
								...
								<div>
									...
									<p className="text-muted-foreground">Comfortable with moderate ease</p>
								</div>
							</div>
							<div className="flex gap-3">
								...
								<div>
									...
									<p className="text-muted-foreground">Loose with extra room for movement</p>
								</div>
							</div>
						</div>
					</section>
					...
					{/* Tips */}
					<section>
						<h3 className="text-base font-semibold mb-3">Shopping Tips</h3>
						<ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
							<li>Wear your normal undergarments when measuring</li>
							<li>Keep the tape measure snug but not tight</li>
							<li>If you're between sizes, consider the fit and how you like to wear items</li>
